...
class CreateClientBloc extends ChangeNotifier with Validators {
  ...
  Stream<bool> get loginFormValidStream =>
      Rx.combineLatest2(nameStream, passwordStream, (e, p) => true);
  ...
  clean() {
    _nameController.add('');
    _surnameController.add('');
    _phoneController.add('');
    _directionController.add('');
    _privateEmailController.add('');
